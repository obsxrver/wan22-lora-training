...
mkdir -p /workspace/wan22-lora-training/datasets

curl -fsSL "https://raw.githubusercontent.com/obsxrver/wan22-lora-training/main/datasets/dataset.toml" -o /workspace/wan22-lora-training/datasets/dataset.toml
curl -fsSL "https://raw.githubusercontent.com/obsxrver/wan22-lora-training/main/datasets/turbo.toml" -o /workspace/wan22-lora-training/datasets/turbo.toml
